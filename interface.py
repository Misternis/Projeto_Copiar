...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidgetA.setWordWrap(False)
        ...
        self.tableWidgetA.verticalHeader().setCascadingSectionResizes(False)
        self.gridLayout.addWidget(self.tableWidgetA, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidgetB, 2, 1, 1, 1)
